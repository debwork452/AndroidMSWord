...
//                Toast.makeText(this@MainActivity, uri.path, Toast.LENGTH_SHORT).show()

              /*  editor!!.onImageUploadComplete(
                    "https://pbs.twimg.com/profile_images/1216813945408966663/vkVajfRz_400x400.jpg",
                    uuid
                )*/
