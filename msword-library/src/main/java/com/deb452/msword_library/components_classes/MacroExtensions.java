...
public class MacroExtensions extends EditorComponent {
    ...
    public void insertMacro(String name, View view, Map<String, Object> settings, int index) {
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(Utilities.INSTANCE.dpToPx(frameLayout.getContext(), 40),
                Utilities.INSTANCE.dpToPx(frameLayout.getContext(), 40));
