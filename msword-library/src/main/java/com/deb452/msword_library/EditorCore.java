...
import com.deb452.msword_library.components_classes.DividerExtensions;
import com.deb452.msword_library.components_classes.HTMLExtensions;
import com.deb452.msword_library.components_classes.ImageExtensions;
import com.deb452.msword_library.components_classes.InputExtensions;
import com.deb452.msword_library.components_classes.ListItemExtensions;
import com.deb452.msword_library.components_classes.MacroExtensions;
import com.deb452.msword_library.components_classes.MapExtensions;
...
import com.deb452.msword_library.models.Op;
 ...
 */
    ...
    protected EditorContent getContent() {
        ...
        if (this.editorSettings.renderType == RenderType.Renderer) {
            Utilities.INSTANCE.toastItOut(this.getContext(),"This option only available in editor mode");
            return null;
        }
